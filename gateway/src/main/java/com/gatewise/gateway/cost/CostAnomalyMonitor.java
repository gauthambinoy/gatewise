package com.gatewise.gateway.cost;
...
import com.gatewise.gateway.config.CostAnomalyProperties;
 ...
 */
@Component
@ConditionalOnProperty(name = "gatewise.cost-alert.enabled", havingValue = "true")
