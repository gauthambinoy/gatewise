 ...
 *
 * <p>Off unless {@code gatewise.compliance.notary-url} is set, and fail-open: a notary outage logs
 * a warning but never breaks the request that produced the anchor. The notary endpoint is what an
