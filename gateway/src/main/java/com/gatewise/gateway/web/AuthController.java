...
public class AuthController {
  ...
  private final com.gatewise.gateway.config.DemoProperties demoProperties;
  private final com.gatewise.gateway.config.RbacProperties rbacProperties;
  ...
  public AuthController(
      ...
      com.gatewise.gateway.config.DemoProperties demoProperties,
      com.gatewise.gateway.config.RbacProperties rbacProperties,
  ...
  public DevLoginResponse demoLogin() {
    ...
    String email = owner != null ? owner.getEmail() : "demo@gatewise.io";
