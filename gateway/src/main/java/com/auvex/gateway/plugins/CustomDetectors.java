...
import com.auvex.gateway.plugins.PluginProperties.CompiledDetector;
import com.auvex.gateway.redaction.Detector;
import com.auvex.gateway.redaction.Match;
import com.auvex.gateway.redaction.PiiType;
 ...
 * normal {@link com.auvex.gateway.redaction.RedactionEngine} overlap resolution and masking just
 * like a built-in detector.
 *
 * <p>The configured patterns are compiled once in the constructor. The detector is active only when
 * {@code auvex.plugins.enabled} is on; otherwise — and whenever no valid custom detector is
