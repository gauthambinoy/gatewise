 ...
 * forwarded unchanged. Tenant attribution comes from {@code auvex.egress.tenant-id}, because an
 * intercepted call carries the app's provider key, not an Auvex key.
 */
@Component
