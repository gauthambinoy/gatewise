...
import com.auvex.gateway.egress.CertificateAuthority;
 ...
 * credential to present. It only exists when {@code auvex.egress.enabled=true}.
 */
@RestController
  ...
  public ResponseEntity<String> caCertificate() {
    try {
      return ResponseEntity.ok()
          .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"auvex-egress-ca.pem\"")
