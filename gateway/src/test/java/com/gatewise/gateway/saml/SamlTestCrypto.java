...
public final class SamlTestCrypto {
  ...
  public static final String SP_ENTITY_ID = "https://gatewise.example/sp";
  public static final String ACS_URL = "https://gatewise.example/auth/saml/okta/acs";
  ...
  private static X509Certificate selfSignedCertificate() {
    try {
      X500Name subject = new X500Name("CN=GateWise SAML Test IdP");
