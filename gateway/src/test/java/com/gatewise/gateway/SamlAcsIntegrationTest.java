...
import com.gatewise.gateway.saml.SamlRelayStateService;
import com.gatewise.gateway.saml.SamlTestCrypto;
...
class SamlAcsIntegrationTest extends AbstractPostgresIntegrationTest {
  ...
  static void samlProvider(DynamicPropertyRegistry registry) {
    registry.add("gatewise.saml.providers.okta.entity-id", () -> SamlTestCrypto.ENTITY_ID);
    registry.add("gatewise.saml.providers.okta.sso-url", () -> "https://idp.example/sso");
    registry.add("gatewise.saml.providers.okta.signing-certificate", () -> SamlTestCrypto.CERT_PEM);
    registry.add("gatewise.saml.providers.okta.sp-entity-id", () -> SamlTestCrypto.SP_ENTITY_ID);
    registry.add("gatewise.saml.providers.okta.acs-url", () -> SamlTestCrypto.ACS_URL);
    registry.add("gatewise.saml.providers.okta.tenant-slug", () -> TENANT_SLUG);
    registry.add("gatewise.saml.providers.okta.auto-provision", () -> "true");
  }
