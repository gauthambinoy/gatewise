...
class AnthropicAdapterIntegrationTest extends AbstractPostgresIntegrationTest {
  ...
  static void properties(DynamicPropertyRegistry registry) {
    registry.add("gatewise.anthropic.enabled", () -> true);
    registry.add("gatewise.anthropic.base-url", () -> "http://localhost:" + ANTHROPIC.getPort());
    registry.add("gatewise.anthropic.api-key", () -> "test-anthropic-key");
  }
