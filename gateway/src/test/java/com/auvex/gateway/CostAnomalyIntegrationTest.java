...
class CostAnomalyIntegrationTest extends AbstractPostgresIntegrationTest {
  ...
  static void properties(DynamicPropertyRegistry registry) {
    registry.add("auvex.cost-alert.enabled", () -> true);
    registry.add("auvex.cost-alert.threshold-usd", () -> "0.01");
    registry.add("auvex.webhook.url", () -> "http://localhost:" + SIEM.getPort() + "/alerts");
  }
