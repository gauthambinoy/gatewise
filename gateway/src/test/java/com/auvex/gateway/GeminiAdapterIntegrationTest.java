...
class GeminiAdapterIntegrationTest extends AbstractPostgresIntegrationTest {
  ...
  static void properties(DynamicPropertyRegistry registry) {
    registry.add("auvex.gemini.enabled", () -> true);
    registry.add("auvex.gemini.base-url", () -> "http://localhost:" + GEMINI.getPort());
    registry.add("auvex.gemini.api-key", () -> "test-gemini-key");
  }
