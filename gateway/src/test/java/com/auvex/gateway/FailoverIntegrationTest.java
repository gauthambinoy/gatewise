...
class FailoverIntegrationTest extends AbstractPostgresIntegrationTest {
  ...
  static void properties(DynamicPropertyRegistry registry) {
    registry.add("auvex.openrouter.base-url", () -> "http://localhost:" + PRIMARY.getPort());
    registry.add("auvex.openrouter.api-key", () -> "primary-key");
    registry.add("auvex.failover.enabled", () -> true);
    registry.add("auvex.failover.base-url", () -> "http://localhost:" + FALLBACK.getPort());
    registry.add("auvex.failover.api-key", () -> "fallback-key");
  }
